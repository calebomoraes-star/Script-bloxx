...
<h1>🪖 Exército Brasileiro RP</h1>

<p>Soldado → Cabo → Sargento → Tenente → Capitão</p>

<input id="nome" placeholder="Nome do soldado">
...
function promover() {
  ...
  p.innerText = nome + ' foi promovido para ' + patente;
  log.appendChild(p);
